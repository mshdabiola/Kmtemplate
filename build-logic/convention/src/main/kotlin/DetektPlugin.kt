    ...
    override fun apply(target: Project) {
        ...
        target.plugins.withId("io.gitlab.arturbosch.detekt") {
            ...
            target.extensions.configure<DetektExtension> {
                ...
                val rootDetektConfig = rootProject.file("detekt.yml")
                val rootDetektComposeConfig = rootProject.file("detekt-compose.yml")
        ...
        target.dependencies {
            // Add detekt-compose plugin to all modules for simplicity.
            add(
                "detektPlugins",
